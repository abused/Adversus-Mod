...
public class BlockRedstone extends RecipeBlockCrops
{
	
	public BlockRedstone()
    {
        this.setBlockName("BlockRedstone");
        this.setBlockTextureName("mm:redstoneseeds");
    }
    ...
    {
     // DEBUG
     System.out.println("BlockRedstone getItemDropped()");
    ...
    public void registerBlockIcons(IIconRegister parIIconRegister)
    {
          ...
          iIcon[2] = parIIconRegister.registerIcon("mm:redstone2");
          iIcon[3] = parIIconRegister.registerIcon("mm:redstone2");  
          ...
          iIcon[7] = parIIconRegister.registerIcon("mm:redstone1");  
