...
public class BlockEmerald extends RecipeBlockCrops
{
	
	public BlockEmerald()
    {
        this.setBlockName("BlockEmerald");
        this.setBlockTextureName("mm:emeraldseeds");
    }
    ...
    {
     // DEBUG
     System.out.println("BlockEmerald getItemDropped()");
    ...
    public void registerBlockIcons(IIconRegister parIIconRegister)
    {
          ...
          iIcon[2] = parIIconRegister.registerIcon("mm:emerald2");
          iIcon[3] = parIIconRegister.registerIcon("mm:emerald2");  
          ...
          iIcon[7] = parIIconRegister.registerIcon("mm:emerald1");  
