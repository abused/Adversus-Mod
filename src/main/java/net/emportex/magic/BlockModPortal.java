...
import util.LightDimensionTeleporter;
import world.DimensionIDs;
...
public class BlockModPortal extends BlockBreakable
{
	...
	public static class Size
	{
		...
		protected boolean getBlockMaterial(Block block){
			return block.getMaterial() == Material.air || block == MagicMod.lightFire || block == MagicMod.lightPortal;
		}
		...
		public void func_150859_c()
		{
			for (int i = 0; i < this.field_150868_h; ++i)
			{
				...
				for (int l = 0; l < this.field_150862_g; ++l)
				{
					...
					this.worldObj.setBlock(j, i1, k, MagicMod.lightPortal, this.field_150865_b, 2);
				}
			}
		}
	}
