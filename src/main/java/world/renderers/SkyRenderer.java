...
public class SkyRenderer extends IRenderHandler {
	...
	public void render(float partialTicks, WorldClient world, Minecraft mc) {
		...
		mc.renderEngine.getTexture(new ResourceLocation("mm:/textures/enviroment/sun.png")); 
		...
		mc.renderEngine.bindTexture(new ResourceLocation("mm:/textures/enviroment/moon_phases.png"));
