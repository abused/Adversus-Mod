package world.biomes.decorators;
...
import world.gen.WorldGenEffectTree;
import world.gen.WorldGenForestBigTree;
import world.gen.WorldGenForestTrees;
...
public class BiomeDecoratorMod extends BiomeDecorator
{
	...
	public BiomeDecoratorMod() {
		coalGen = new WorldGenMinable(Blocks.coal_ore, 16, MagicMod.LightStone);
		ironGen = new WorldGenMinable(Blocks.iron_ore, 8, MagicMod.LightStone);
		goldGen = new WorldGenMinable(Blocks.gold_ore, 8, MagicMod.LightStone);
		redstoneGen = new WorldGenMinable(Blocks.redstone_ore, 7, MagicMod.LightStone);
		diamondGen = new WorldGenMinable(Blocks.diamond_ore, 7, MagicMod.LightStone);
		lapisGen = new WorldGenMinable(Blocks.lapis_ore, 6, MagicMod.LightStone);
