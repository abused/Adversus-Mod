...
public class BlockModLightLog extends BlockModLogBase
{
    ...
    public BlockModLightLog(String name, String blockTextureName){
    	this.setBlockName("log_lightOak");
    	this.setBlockTextureName("log_lightOak");
    ...
    public void registerBlockIcons(IIconRegister p_149651_1_)
    {
        ...
        {
            this.field_150167_a[i] = p_149651_1_.registerIcon("mm:" + this.getTextureName() + "_" + field_150169_M[i]);
            this.field_150166_b[i] = p_149651_1_.registerIcon("mm:" + this.getTextureName() + "_" + field_150169_M[i] + "_top");
        }
    }
}